...
# 🏛️ Sobre la clase
La asignatura tiene una intensidad de 3 créditos académicos. Los objetivos clave son:
- Presentar estrategias para caracterizar y solucionar problemas usando la informática.
- Proporcionar herramientas para la definición y desarrollo de algoritmos, y su implementación en un lenguaje de programación.

## Contenidos temáticos
El curso cubre los siguientes temas fundamentales, que se exploran en los talleres y proyectos:
- Solución de problemas: Ciclo de vida, pensamiento computacional, abstracción y algoritmos.
- Construcciones básicas de programación: Variables, tipos de datos, expresiones, estructuras de control (condicionales e iteraciones) y funciones.
